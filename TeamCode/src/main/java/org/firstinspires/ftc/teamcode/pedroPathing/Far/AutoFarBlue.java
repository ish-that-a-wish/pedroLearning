...
import static org.firstinspires.ftc.teamcode.pedroPathing.Far.BlueFarConstants.FIRST_SPIKE;
...
import static org.firstinspires.ftc.teamcode.pedroPathing.Far.BlueFarConstants.SECOND_SPIKE;
...
//            Log.i("WAITING METHOD CURRENT POSE: ", String.valueOf(follower.getPose()));
    ...
    private void buildPaths() {
        ...
        pickUpSpike1 = buildAPath(moveToSpike1Pickup, moveToShootSpike1, FIRST_SPIKE.getHeading());

        pickUpSpike2 = buildAPath(moveToSpike2Pickup, moveToShootSpike2, SECOND_SPIKE.getHeading());

//        gatePickup = buildAPath(moveToGate, moveToShootGate, Math.toRadians(155), Math.toRadians(180));
        gatePickup =  buildAPath(moveToGateNoIntake, moveToShootGateNoIntake, GATE_PICKUP_NO_INTAKE.getHeading(), SHOOTING_POSE.getHeading());
        ...
        gateNoIntake = buildAPath(moveToGateNoIntake, moveToShootGateNoIntake, GATE_PICKUP_NO_INTAKE.getHeading(), SHOOTING_POSE.getHeading());
        newMoveGate = follower.pathBuilder()
                .addPath(moveToGate)
...
//        AutoAction currentAction = AutoAction.MOVE_OFF_LINE;
        ...
        switch (currentAction) {
            ...
            case GATE_PICKUP:
                follower.followPath(newMoveGate);
                break;
    ...
    private void addIfNotPresent(
            ArrayList<AutoFarBlue.AutoAction> list,
            AutoFarBlue.AutoAction action
    ) {
