...
public class RedFarConstants {
    ...
    public static Pose GATE_PICKUP_NO_INTAKE = new Pose(middle + (multiplier * 62), 63, Math.toRadians(90 - (multiplier * 90)));
    ...
    public static Pose SECRET_TUNNEL_AFTER_GATE = new Pose(middle + (multiplier * 62), 45, Math.toRadians(270));
    ...
    public static Pose MOVE_OFF_LINE = new Pose(middle + (multiplier * 22), 24);
