...
public class Tuning extends SelectableOpMode {
    ...
    public MultipleTelemetry telemetryA = new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry());
...
//        Drawing.init();
    ...
    public static void drawOnlyCurrent() {
        try {
            Drawing.drawRobot(follower.getPose(), "FF2A00");
            Drawing.sendPacket();
        } catch (Exception e) {
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetry.addLine("pose" + follower.getPose());
        telemetry.update();
        follower.update();
        drawOnlyCurrent();
    }
...
class TranslationalTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addLine("Zero Line" + 0);
        telemetry.addLine("Error X" + follower.errorCalculator.getTranslationalError().getXComponent());
        telemetry.addLine("Error Y" + follower.errorCalculator.getTranslationalError().getYComponent());
        telemetry.update();
    }
}
...
class HeadingTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addLine("Zero Line" + 0);
        telemetry.addLine("Error" + follower.errorCalculator.getHeadingError());
        telemetry.update();
    }
}
...
class DriveTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addLine("Zero Line" + 0);
        telemetry.addLine("Error" + follower.errorCalculator.getDriveErrors()[1]);
        telemetry.update();
    }
}
